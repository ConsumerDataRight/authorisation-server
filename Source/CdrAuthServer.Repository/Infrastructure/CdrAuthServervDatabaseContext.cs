namespace CdrAuthServer.Repository.Infrastructure
{
    ...
    public class CdrAuthServervDatabaseContext : DbContext
    {
        public CdrAuthServervDatabaseContext()
        {
        }

        public CdrAuthServervDatabaseContext(DbContextOptions<CdrAuthServervDatabaseContext> options) : base(options)
        {
        }
