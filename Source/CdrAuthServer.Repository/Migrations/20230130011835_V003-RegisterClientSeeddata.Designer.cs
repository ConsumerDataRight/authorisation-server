...
namespace CdrAuthServer.Repository.Migrations
{
    ...
    [Migration("20230130011835_V003-RegisterClientSeeddata")]
    partial class V003RegisterClientSeeddata
    {
            ...
            modelBuilder.Entity("CdrAuthServer.Repository.Entities.Grant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 1, 30, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(2452),
                            Data = "{\"refresh_token\":\"valid-refresh-token\",\"account_id\":[\"123\",\"456\",\"789\"]}",
                            ExpiresAt = new DateTime(2024, 1, 30, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(2455),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2023, 1, 30, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(3055),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"12345678-1234-1234-1234-111122223333\"}",
                            ExpiresAt = new DateTime(2024, 1, 30, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(3056),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2022, 1, 29, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(3083),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"f31fd076-f661-43f0-a4d0-98daf74dd8a2\"}",
                            ExpiresAt = new DateTime(2023, 1, 29, 1, 18, 34, 844, DateTimeKind.Utc).AddTicks(3083),
                            GrantType = "refresh_token",
