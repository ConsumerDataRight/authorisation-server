...
namespace CdrAuthServer.Repository.Migrations
{
    ...
    [Migration("20230212220828_V006-Seed-SoftwareProduct-Status")]
    partial class V006SeedSoftwareProductStatus
    {
            ...
            modelBuilder.Entity("CdrAuthServer.Repository.Entities.Grant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 2, 12, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8060),
                            Data = "{\"refresh_token\":\"valid-refresh-token\",\"account_id\":[\"123\",\"456\",\"789\"]}",
                            ExpiresAt = new DateTime(2024, 2, 12, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8061),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2023, 2, 12, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8613),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"12345678-1234-1234-1234-111122223333\"}",
                            ExpiresAt = new DateTime(2024, 2, 12, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8614),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2022, 2, 11, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8643),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"84290e1a-919d-4ed9-8e88-c47c283c51ea\"}",
                            ExpiresAt = new DateTime(2023, 2, 11, 22, 8, 27, 831, DateTimeKind.Utc).AddTicks(8643),
                            GrantType = "refresh_token",
