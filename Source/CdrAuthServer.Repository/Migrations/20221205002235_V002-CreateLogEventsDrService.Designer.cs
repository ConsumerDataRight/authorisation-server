...
namespace CdrAuthServer.Repository.Migrations
{
    ...
    [Migration("20221205002235_V002-CreateLogEventsDrService")]
    partial class V002CreateLogEventsDrService
    {
            ...
            modelBuilder.Entity("CdrAuthServer.Repository.Entities.Grant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 12, 5, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(7644),
                            Data = "{\"refresh_token\":\"valid-refresh-token\",\"account_id\":[\"123\",\"456\",\"789\"]}",
                            ExpiresAt = new DateTime(2023, 12, 5, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(7647),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2022, 12, 5, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(8060),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"12345678-1234-1234-1234-111122223333\"}",
                            ExpiresAt = new DateTime(2023, 12, 5, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(8060),
                        ...
                        new
                        {
                            ...
                            ClientId = "c6327f87-687a-4369-99a4-eaacd3bb8210",
                            CreatedAt = new DateTime(2021, 12, 4, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(8085),
                            Data = "{\"response_type\":\"code id_token\",\"CdrArrangementId\":\"9af3f5da-fb12-4690-91ae-459d014d87dd\"}",
                            ExpiresAt = new DateTime(2022, 12, 4, 0, 22, 35, 469, DateTimeKind.Utc).AddTicks(8086),
                            GrantType = "refresh_token",
