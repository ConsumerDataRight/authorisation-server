namespace CdrAuthServer.Repository.Configuration
{
    ...
    {
        private const string CdrRegister = "cdr-register";
        private const string DummyUrl = "https://cdrsandbox.gov.au/logo192.png";
        ...
        public void Configure(EntityTypeBuilder<SoftwareProduct> builder)
        {
            ...
            builder.HasData(
                ...
                new SoftwareProduct()
                {
                    ...
                    SoftwareProductId = CdrRegister,
                    SoftwareProductName = CdrRegister,
                    SoftwareProductDescription = "Mock Register",
                    LogoUri = DummyUrl,
                    Status = EntityStatus.Active,
                    LegalEntityId = CdrRegister,
                    LegalEntityName = CdrRegister,
                    LegalEntityStatus = EntityStatus.Active,
                    BrandId = CdrRegister,
                    BrandName = CdrRegister,
                    BrandStatus = EntityStatus.Active,
                });
        }
    }
