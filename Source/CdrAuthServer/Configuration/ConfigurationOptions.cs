...
namespace CdrAuthServer.Configuration
{
    ...
    {
        public const string ConfigurationSectionName = "CdrAuthServer";
        ...
        // ResponseTypesSupported is always "code" as Hybrid flow is decommissioned.
        public IList<string>? ResponseTypesSupported
        {
            get { return [ResponseTypes.AuthCode]; }
        }
