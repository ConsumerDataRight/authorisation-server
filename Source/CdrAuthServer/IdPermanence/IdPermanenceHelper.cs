...
namespace CdrAuthServer.IdPermanence
{
    ...
    public static class IdPermanenceHelper
    {
        ...
        {
            string privateKey = config["CdrAuthServer:IdPermanence:PrivateKey"] ?? string.Empty;
            ...
            var path = config["CdrAuthServer:IdPermanence:Certificate:Path"];
            var pwd = config["CdrAuthServer:IdPermanence:Certificate:Password"];
