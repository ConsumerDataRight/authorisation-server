...
{
    public class US18469_CdrAuthServer_TokenRevocation : BaseTest, IClassFixture<RegisterSoftwareProductFixture>
    {
            ...
            int sharingDuration = SHARING_DURATION)
        {
            (var authCode, _) = await new DataHolder_Authorise_APIv2
            {
                ...
                RequestUri = await PAR_GetRequestUri(scope: US12963_CdrAuthServer_Token.SCOPE_TOKEN_ACCOUNTS, sharingDuration: sharingDuration) 
            }.Authorise();
        ...
        public async Task AC09_Post_AccessTokenWithDifferentHolderOfKey_ShouldRespondWith_200OK(string jwtCertificateFilename, string jwtCertificatePassword, HttpStatusCode expectedStatusCode)
        {
            ...
            var response = await DataHolder_TokenRevocation_API.SendRequest(
                ...
                clientId: GetClientId(ADDITIONAL_SOFTWAREPRODUCT_ID),
