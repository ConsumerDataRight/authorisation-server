...
namespace CdrAuthServer.IntegrationTests.Infrastructure
{
    /// <summary>
    /// Call API
    /// </summary>
    public class API
    {
        ...
        public async Task<HttpResponseMessage> SendAsync(bool AllowAutoRedirect = true, string? XTlsClientCertThumbprint = null)
        {
            // Build request
            ...
            async Task<HttpResponseMessage> SendRequest(HttpRequestMessage request)
            {
                ...
                BaseTest.AttachHeadersForStandAlone(request.RequestUri?.AbsoluteUri ?? throw new NullReferenceException(),
                                                    request.Headers,
                                                    XTlsClientCertThumbprint);
